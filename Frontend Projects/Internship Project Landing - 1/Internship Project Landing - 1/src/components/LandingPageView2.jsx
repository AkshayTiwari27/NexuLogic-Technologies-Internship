      ...
      <div className="w-full max-w-3xl space-y-8">
        ...
        <div id="videos">
          ...
          >
            <Card className="bg-white bg-opacity-90 backdrop-blur-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-indigo-600">Music Videos</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <ScrollArea className="">
          ...
          <div id="performances" className="mt-8">
            <motion.div
              className="p-6 bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 mb-8"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
